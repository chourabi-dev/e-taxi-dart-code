            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    MainScreenTitle(title: "Create your account"),
                    SizedBox(height: 30),
                    InputLabel(label: "Full name", inputPlaceHolder: "Your full name")
                    ,
                    SizedBox(height: 15),
                    ...
                    , 
                    SizedBox(height: 15),
                    InputLabel(label: "Confirm password", inputPlaceHolder: "Confirm your password") 
                    , 
                    ...
                    CustomButton(text: "Create", function: createAccountFunction,)
