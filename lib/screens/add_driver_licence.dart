...
class AddDriverLicense extends StatefulWidget {
  const AddDriverLicense({super.key});

  @override
  State<AddDriverLicense> createState() => _AddDriverLicenseState();
}
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 7),
                    MainScreenTitle(title: "Add your driver licence"),
                    SizedBox(height: 30),
                    ...
                    InputLabel(label: "Driver licence number", inputPlaceHolder: "Your drivr licence number")
                    ,
                    SizedBox(height: 15),

                    InputLabel(label: "Expiration Date", inputPlaceHolder: "The date of expiration")
                    ,
                    SizedBox(height: 15),
