...
class AddProCardNumber extends StatefulWidget {
  const AddProCardNumber({super.key});

  @override
  State<AddProCardNumber> createState() => _AddProCardNumberState();
}

class _AddProCardNumberState extends State<AddProCardNumber> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 7),
                    MainScreenTitle(title: "Add your professional driver card number"),
                    SizedBox(height: 30),
                    ...
                    InputLabel(label: "Professional driver card number", inputPlaceHolder: "Your drivr licence number")
                    ,
                    SizedBox(height: 15),

                    InputLabel(label: "Date", inputPlaceHolder: "Enter the date")
                    ,
                    SizedBox(height: 15),
